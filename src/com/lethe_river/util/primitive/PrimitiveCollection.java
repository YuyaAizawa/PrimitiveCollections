 ...
 *
 * 実装する場合は対応するプリミティブTに対して以下のメソッドを実装すること boolean contains(T t)
 *
 * @author YuyaAizawa
 *
...
public interface PrimitiveCollection<T> extends Serializable {
	...
	/**
	 * このコレクションの要素数を返す. 要素数がInteger.MAX_VALUEより大きい場合はInteger.MAX_VALUEを返す.
	 *
	 * @return 要素数
	 */
	int size();
	...
	/**
	 * ラッパー型のCollectionのビューを返す. ビューに対する操作はこのインスタンスに反映される．
	 *
